...
const myBasicPerks: IPerk[] = [
  { label: 'My First Perk', cps: 0.1, cost: 10, category: 'basic', owned: 0 },
  { label: 'My Second Perk', cps: 0.1, cost: 10, category: 'basic', owned: 0 },
  { label: 'My Third Perk', cps: 0.1, cost: 10, category: 'basic', owned: 0 },
]
